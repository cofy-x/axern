...
for runtime_name in runsc runc; do
  metricsz_wait_value "axern.axnoded_bundle_template_total" "counter" "1" \
    "axern.runtime=${runtime_name}" "axern.rootfs_type=local" "axern.result=hit"
  metricsz_wait_value "axern.axnoded_bundle_materialize_duration_seconds" "histogram" "2" \
  ...
  metricsz_assert_value "${metrics_output}" "axern.axnoded_bundle_template_total" "counter" "1" \
    "axern.runtime=${runtime_name}" "axern.rootfs_type=local" "axern.result=miss"
  metricsz_assert_value "${metrics_output}" "axern.axnoded_bundle_template_total" "counter" "1" \
    "axern.runtime=${runtime_name}" "axern.rootfs_type=local" "axern.result=hit"
  metricsz_assert_value "${metrics_output}" "axern.axnoded_bundle_materialize_duration_seconds" "histogram" "2" \
    "axern.runtime=${runtime_name}" "axern.rootfs_type=local" "axern.result=ok"
done
