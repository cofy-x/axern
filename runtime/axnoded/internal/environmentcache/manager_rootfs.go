...
func (lm *EnvironmentCache) GetRootfs(cfg RootfsConfig) (*RootFS, error) {
	rootfs, _, err := lm.GetRootfsWithReport(cfg)
	return rootfs, err
}

func (lm *EnvironmentCache) GetRootfsWithReport(cfg RootfsConfig) (*RootFS, RootfsPrepareReport, error) {
