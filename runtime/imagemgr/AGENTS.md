...
- Keep `cmd/imagemgr` thin, process wiring in `internal/app`, the Unix-socket contract and request orchestration in `api`, and authoritative resource/lease records in `internal/mountstore`.
