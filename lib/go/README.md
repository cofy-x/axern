...
- [`nodecapability`](./nodecapability): canonical observed node-capability catalog, extension validation, and snapshot eligibility rules shared by the node runtime and control plane.
