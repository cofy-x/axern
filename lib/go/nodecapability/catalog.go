...
const (
	...
	RuntimeObservationValidity = 20 * time.Minute
)
...
var definitions = mustCatalog(map[capabilityv1.PlatformCapability]Definition{
	...
	capabilityv1.PlatformCapability_PLATFORM_CAPABILITY_RUNC_MEMORY_ENFORCEMENT_SELF_TEST:     platformDefinition(capabilityv1.PlatformCapability_PLATFORM_CAPABILITY_RUNC_MEMORY_ENFORCEMENT_SELF_TEST, capabilityv1.CapabilityProvider_CAPABILITY_PROVIDER_RUNC_SELF_TEST, IdentityRuntime, RuntimeObservationValidity, capabilityv1.CapabilityLossPolicy_CAPABILITY_LOSS_POLICY_ADMISSION_ONLY, AudienceInternalFact, VerifierNone),
	capabilityv1.PlatformCapability_PLATFORM_CAPABILITY_RUNSC_MEMORY_ENFORCEMENT_SELF_TEST:    platformDefinition(capabilityv1.PlatformCapability_PLATFORM_CAPABILITY_RUNSC_MEMORY_ENFORCEMENT_SELF_TEST, capabilityv1.CapabilityProvider_CAPABILITY_PROVIDER_RUNSC_SELF_TEST, IdentityRuntime, RuntimeObservationValidity, capabilityv1.CapabilityLossPolicy_CAPABILITY_LOSS_POLICY_ADMISSION_ONLY, AudienceInternalFact, VerifierNone),
	...
	capabilityv1.PlatformCapability_PLATFORM_CAPABILITY_RUNSC_EPHEMERAL_ENFORCEMENT_SELF_TEST: platformDefinition(capabilityv1.PlatformCapability_PLATFORM_CAPABILITY_RUNSC_EPHEMERAL_ENFORCEMENT_SELF_TEST, capabilityv1.CapabilityProvider_CAPABILITY_PROVIDER_RUNSC_SELF_TEST, IdentityRuntime, RuntimeObservationValidity, capabilityv1.CapabilityLossPolicy_CAPABILITY_LOSS_POLICY_ADMISSION_ONLY, AudienceInternalFact, VerifierNone),
})
...
// CatalogDigest binds derived evidence to the exact catalog semantics used to
// evaluate its dependency graph.
