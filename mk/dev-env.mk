...
local-node-images-build: ## Build only axnoded's runtime base and node-all-in-one images
	AXERN_LOCAL_IMAGE_SCOPE=node bash $(ROOTDIR)/scripts/dev-env/build-images.sh
