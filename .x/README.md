...
For a task contained inside one module, start with the root [Agent Contract](../AGENTS.md), then follow the Module Guide to the local `AGENTS.md` and `README.md`. Do not read the other `.x` files unless the task matches their scope.
...
- Keep module-specific package maps and validation commands in the module's `AGENTS.md` or `README.md`.
