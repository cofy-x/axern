...
- Use tunnels when a sandbox must reach a caller-local upstream such as a mock HTTP service or development server. Caller-specific credentials and configuration are not part of the Axern sandbox lifecycle.
