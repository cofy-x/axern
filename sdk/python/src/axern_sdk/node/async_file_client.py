"""Async node sandbox file RPC mixin."""
...
class AsyncNodeSandboxFileMixin:
    ...
    async def upload_archive(
        ...
        *,
        ...
        if not path:
            raise ValueError("path is required")
        try:
            await node_pb2_grpc.NodeSandboxStub(self._gateway_channel()).UploadArchive(
    ...
    async def _upload_archive_requests(
        self,
        *,
        path: str,
        ...
        create_parents: bool,
        overwrite: bool,
    ) -> AsyncIterator[node_pb2.UploadArchiveRequest]:
