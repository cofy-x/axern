...
class Run(_message.Message):
    __slots__ = ("id", "namespace", "environment_id", "allocation_id", "status", "config", "labels", "version", "created_at", "updated_at", "exit_code", "message", "diagnostic_code", "capability_conditions", "node_id", "environment_spec", "resolved_environment_spec")
