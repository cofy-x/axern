...
class GetAllocationCapabilityDiagnosticsResponse(_message.Message):
    __slots__ = ("allocation_id", "node_id", "required_dependencies", "admitted_dependencies", "condition_set", "reconcile", "create_admission_recorded", "create_dependency_set_digest", "create_admitted_at", "memory_admission", "latest_memory_observation")
    ALLOCATION_ID_FIELD_NUMBER: _ClassVar[int]
    NODE_ID_FIELD_NUMBER: _ClassVar[int]
