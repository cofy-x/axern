...
class NamespaceQuota(_message.Message):
    __slots__ = ("namespace", "cpu_milli_limit", "memory_bytes_limit", "reserved_cpu_milli", "reserved_memory_bytes", "available_cpu_milli", "available_memory_bytes", "version", "created_at", "updated_at")
...
class NamespaceQuotaEvent(_message.Message):
    __slots__ = ("id", "namespace", "type", "workload_type", "workload_id", "environment_id", "reason", "requested_cpu_milli", "reserved_cpu_milli", "cpu_milli_limit", "available_cpu_milli", "requested_memory_bytes", "reserved_memory_bytes", "memory_bytes_limit", "available_memory_bytes", "message", "created_at")
...
class NamespaceQuotaLimits(_message.Message):
    ...
    def __init__(self, cpu_milli: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ..., memory_bytes: _Optional[_Union[_wrappers_pb2.Int64Value, _Mapping]] = ...) -> None: ...
