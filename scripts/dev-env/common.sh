...
COMPOSE_PROJECT_NAME="${COMPOSE_PROJECT_NAME:-axern-source}"
...
NYDUS_SOURCE_IMAGE="${NYDUS_SOURCE_IMAGE:-python:3.12-slim}"
...
AXERN_TEST_PYTHON_IMAGE="${AXERN_TEST_PYTHON_IMAGE:-python:3.12-slim}"
