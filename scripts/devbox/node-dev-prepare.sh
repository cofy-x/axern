...
CONTROL_PLANE_TLS_CERT="${AXERN_DEV_CONTROL_PLANE_TLS_CERT:-${DEV_DIR}/certs/client.crt}"
CONTROL_PLANE_TLS_KEY="${AXERN_DEV_CONTROL_PLANE_TLS_KEY:-${DEV_DIR}/certs/client.key}"
