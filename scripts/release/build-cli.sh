...
if [ -n "${AXERN_LOCAL_IMAGE_LOCK_FILE:-}" ]; then
  for key in POSTGRES_IMAGE CONTROLD_IMAGE TUNNELD_IMAGE GATEWAYD_IMAGE NODE_ALL_IN_ONE_IMAGE PYTHON311_RUNTIME_IMAGE SERVER_BASE_RUNTIME_IMAGE CODING_BASE_RUNTIME_IMAGE DESKTOP_BASE_RUNTIME_IMAGE CLAUDE_CODE_BUNDLE_IMAGE CODEX_BUNDLE_IMAGE OTEL_COLLECTOR_IMAGE OTEL_LGTM_IMAGE; do
