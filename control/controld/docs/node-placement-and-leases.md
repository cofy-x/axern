...
Capability mismatch, missing evidence, invalid identity, and expired evidence are fail-closed eligibility failures. They never enter the transient-health fallback.
