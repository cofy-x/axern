...
func TestConcurrentAdmissionDoesNotOversellNodeResources(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			record := &nodekernel.Record{NodeID: nodeID, NodeTarget: "127.0.0.1:24010", Lifecycle: nodekernel.LifecycleActive, RegisteredAt: now, LastHeartbeatAt: now, Summary: summary}
