...
type QuotaSummary struct {
	...
	EphemeralStorageConstrained int `json:"ephemeral_storage_constrained"`
	CPUPressure                 int `json:"cpu_pressure"`
	MemoryPressure              int `json:"memory_pressure"`
	EphemeralStoragePressure    int `json:"ephemeral_storage_pressure"`
}
...
type QuotaDTO struct {
	...
	EphemeralStorageUsagePercent   *int64 `json:"ephemeral_storage_usage_percent,omitempty"`
...
type QuotaEventDTO struct {
	...
	MemoryBytesLimit               *int64 `json:"memory_bytes_limit,omitempty"`
	AvailableMemoryBytes           *int64 `json:"available_memory_bytes,omitempty"`
	RequestedEphemeralStorageBytes int64  `json:"requested_ephemeral_storage_bytes,omitempty"`
	ReservedEphemeralStorageBytes  int64  `json:"reserved_ephemeral_storage_bytes,omitempty"`
	EphemeralStorageBytesLimit     *int64 `json:"ephemeral_storage_bytes_limit,omitempty"`
	AvailableEphemeralStorageBytes *int64 `json:"available_ephemeral_storage_bytes,omitempty"`
