...
Use a published SDK version that matches the Axern gateway and runtime, and review the corresponding [release notes](https://github.com/cofy-x/axern/tree/main/docs/releases) before upgrading.
