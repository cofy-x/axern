...
The durable execution chain is Environment -> Run -> Allocation -> runsc sandbox. Allocation-local files, archives, retained logs, process operations, SSH, and Tunnel remain supported; persistent storage is caller-owned.
